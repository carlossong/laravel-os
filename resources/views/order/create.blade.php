                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="w-full mx-auto px-2">
                        ...
                        <div id='recipients' class="w-full p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                            <h1 class="text-3xl font-bold text-gray-600 text-center py-4 mb-4">Nova Ordem de Serviço</h1>
                            <form class="w-full" method="post" action="{{ route('order.store') }}">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input id="client_search" type="text" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Digite o nome do cliente" required>
