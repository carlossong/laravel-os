                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="w-full mx-auto px-2">
                        ...
                        <div id='recipients' class="w-full p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                            <h1 class="text-3xl font-bold text-gray-600 text-center py-4 mb-4">Cadastro de Produtos</h1>
                            <form action="{{ route('product.store') }}" method="post" class="w-full">
                                @csrf
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full px-3 mb-6 md:mb-2">
                                        ...
                                        <textarea title="description" name="description" class="resize border rounded-md appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" rows="5">{{ old('description') }}</textarea>
                                    </div>
