                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="widget-box">
                        <div class="container">
                            ...
                            <a href="{{ route('cliente.create') }}" class="icon-plus inline-flex items-center h-8 px-4 m-2 text-sm text-blue-100 transition-colors duration-150 bg-blue-700 rounded-lg focus:shadow-outline hover:bg-blue-800">Cliente</a>
